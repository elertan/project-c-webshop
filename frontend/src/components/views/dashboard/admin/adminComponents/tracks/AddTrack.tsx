...
const AddTrack: React.FunctionComponent<
    IProps & WithApolloClient<{}> & RouteComponentProps<{}>> = props => {
                    ...
                    render={(fieldProps: FieldProps<IFormikValues>) => {
                        ...
                        return (
                            <Form.Field required error={error}>
                                ...
                                <input {...fieldProps.field} placeholder="Length of track in ms" required />
                            </Form.Field>
                        );
                    }}
                />
                    ...
                    render={(fieldProps: FieldProps<IFormikValues>) => {
                        ...
                        return (
                            <Form.Field required error={error}>
                                ...
                                <input {...fieldProps.field} placeholder="True or false" required />
                            </Form.Field>
                        );
                    }}
                />
                    ...
                    render={(fieldProps: FieldProps<IFormikValues>) => {
                        ...
                        return (
                            <Form.Field required error={error}>
                                ...
                                <input {...fieldProps.field} placeholder="The URL to the preview (if any)" required />
                            </Form.Field>
                        );
                    }}
                />
